package com.androidkotlin.mynotes.ui.customsviews
...
import com.androidkotlin.mynotes.extensions.dip
import com.androidkotlin.mynotes.extensions.getColorRes
...
class ColorPickerView : LinearLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        Note.Color.values().forEach { color -> //TODO "это отвратительно" это должно быть за пределами View
            addView(
